...
app.get('/wells/:id', function (req, res){
    ...
    const s1_w1_query = "SELECT p1.IXM_w1, p1.images_folder_name, w1.w1_filepath, w1.site_number, w1.image_folder_name, w1.path_found, w1.experiment_date, w1.well_name FROM wavelength_1 w1, plate_wells pw, ucsc_csc_plates p1 WHERE w1.plate_name=pw.UCSC_CSC_plate and w1.cell_line=pw.Cell_lines and w1.timepoint=pw.TimePoint and w1.Magnification=pw.Magnification and w1.experiment_date=pw.experiment_date and pw.well_name=w1.well_name and p1.images_folder_name=w1.image_folder_name and p1.experiment_date=w1.experiment_date and p1.edu_stainset_number = 1 and pw.id=?";
    const s1_w2_query = "SELECT p1.IXM_w2, p1.images_folder_name, w2.w2_filepath, w2.site_number, w2.image_folder_path, w2.path_found, w2.experiment_date, w2.well_name FROM wavelength_2 w2, plate_wells pw, ucsc_csc_plates p1 WHERE w2.plate_name=pw.UCSC_CSC_plate and w2.cell_line=pw.Cell_lines and w2.timepoint=pw.TimePoint and w2.Magnification=pw.Magnification and w2.experiment_date=pw.experiment_date and pw.well_name=w2.well_name and p1.images_folder_name=w2.image_folder_path and p1.experiment_date=w2.experiment_date and p1.edu_stainset_number = 1 and pw.id=?";
    const s1_w3_query = "SELECT p1.IXM_w3, p1.images_folder_name, w3.w3_filepath, w3.site_number, w3.image_folder_name, w3.path_found, w3.experiment_date, w3.well_name FROM wavelength_3 w3, plate_wells pw, ucsc_csc_plates p1 WHERE w3.plate_name=pw.UCSC_CSC_plate and w3.cell_line=pw.Cell_lines and w3.timepoint=pw.TimePoint and w3.Magnification=pw.Magnification and w3.experiment_date=pw.experiment_date and pw.well_name=w3.well_name and p1.images_folder_name=w3.image_folder_name and p1.experiment_date=w3.experiment_date and p1.edu_stainset_number = 1 and pw.id=?";
    const s1_w4_query = "SELECT p1.IXM_w4, p1.images_folder_name, w4.w4_filepath, w4.site_number, w4.image_folder_name, w4.path_found, w4.experiment_date, w4.well_name FROM wavelength_4 w4, plate_wells pw, ucsc_csc_plates p1 WHERE w4.plate_name=pw.UCSC_CSC_plate and w4.cell_line=pw.Cell_lines and w4.timepoint=pw.TimePoint and w4.Magnification=pw.Magnification and w4.experiment_date=pw.experiment_date and pw.well_name=w4.well_name and p1.images_folder_name=w4.image_folder_name and p1.experiment_date=w4.experiment_date and p1.edu_stainset_number = 1 and pw.id=?";
    ...
    const s2_w3_query = "SELECT p1.IXM_w3, p1.images_folder_name, w3.w3_filepath, w3.site_number, w3.image_folder_name, w3.path_found, w3.experiment_date, w3.well_name FROM wavelength_3 w3, plate_wells pw, ucsc_csc_plates p1 WHERE w3.plate_name=pw.UCSC_CSC_plate and w3.cell_line=pw.Cell_lines and w3.timepoint=pw.TimePoint and w3.Magnification=pw.Magnification and w3.experiment_date=pw.experiment_date and pw.well_name=w3.well_name and p1.images_folder_name=w3.image_folder_name and p1.experiment_date=w3.experiment_date and p1.edu_stainset_number = 0 and pw.id=?";
    const s2_w4_query = "SELECT p1.IXM_w4, p1.images_folder_name, w4.w4_filepath, w4.site_number, w4.image_folder_name, w4.path_found, w4.experiment_date, w4.well_name FROM wavelength_4 w4, plate_wells pw, ucsc_csc_plates p1 WHERE w4.plate_name=pw.UCSC_CSC_plate and w4.cell_line=pw.Cell_lines and w4.timepoint=pw.TimePoint and w4.Magnification=pw.Magnification and w4.experiment_date=pw.experiment_date and pw.well_name=w4.well_name and p1.images_folder_name=w4.image_folder_name and p1.experiment_date=w4.experiment_date and p1.edu_stainset_number = 0 and pw.id=?";
   

  


    var well_images_sql = "SELECT p1.IXM_w1, p1.images_folder_name, w1.w1_filepath, w1.site_number, w1.image_folder_name, w1.path_found, w1.experiment_date, w1.well_name FROM wavelength_1 w1, plate_wells pw, ucsc_csc_plates p1 WHERE w1.plate_name=pw.UCSC_CSC_plate and w1.cell_line=pw.Cell_lines and w1.timepoint=pw.TimePoint and w1.Magnification=pw.Magnification and w1.experiment_date=pw.experiment_date and pw.well_name=w1.well_name and p1.images_folder_name=w1.image_folder_name and p1.experiment_date=w1.experiment_date and p1.edu_stainset_number = 1 and pw.id=?; SELECT p1.IXM_w2, p1.images_folder_name, w2.w2_filepath, w2.site_number, w2.image_folder_path, w2.path_found, w2.experiment_date, w2.well_name FROM wavelength_2 w2, plate_wells pw, ucsc_csc_plates p1 WHERE w2.plate_name=pw.UCSC_CSC_plate and w2.cell_line=pw.Cell_lines and w2.timepoint=pw.TimePoint and w2.Magnification=pw.Magnification and w2.experiment_date=pw.experiment_date and pw.well_name=w2.well_name and p1.images_folder_name=w2.image_folder_path and p1.experiment_date=w2.experiment_date and p1.edu_stainset_number = 1 and pw.id=?; SELECT p1.IXM_w3, p1.images_folder_name, w3.w3_filepath, w3.site_number, w3.image_folder_name, w3.path_found, w3.experiment_date, w3.well_name FROM wavelength_3 w3, plate_wells pw, ucsc_csc_plates p1 WHERE w3.plate_name=pw.UCSC_CSC_plate and w3.cell_line=pw.Cell_lines and w3.timepoint=pw.TimePoint and w3.Magnification=pw.Magnification and w3.experiment_date=pw.experiment_date and pw.well_name=w3.well_name and p1.images_folder_name=w3.image_folder_name and p1.experiment_date=w3.experiment_date and p1.edu_stainset_number = 1 and pw.id=?; SELECT p1.IXM_w4, p1.images_folder_name, w4.w4_filepath, w4.site_number, w4.image_folder_name, w4.path_found, w4.experiment_date, w4.well_name FROM wavelength_4 w4, plate_wells pw, ucsc_csc_plates p1 WHERE w4.plate_name=pw.UCSC_CSC_plate and w4.cell_line=pw.Cell_lines and w4.timepoint=pw.TimePoint and w4.Magnification=pw.Magnification and w4.experiment_date=pw.experiment_date and pw.well_name=w4.well_name and p1.images_folder_name=w4.image_folder_name and p1.experiment_date=w4.experiment_date and p1.edu_stainset_number = 1 and pw.id=?; SELECT p1.IXM_w1, p1.images_folder_name, w1.w1_filepath, w1.site_number, w1.image_folder_name, w1.path_found, w1.experiment_date, w1.well_name FROM wavelength_1 w1, plate_wells pw, ucsc_csc_plates p1 WHERE w1.plate_name=pw.UCSC_CSC_plate and w1.cell_line=pw.Cell_lines and w1.timepoint=pw.TimePoint and w1.Magnification=pw.Magnification and w1.experiment_date=pw.experiment_date and pw.well_name=w1.well_name and p1.images_folder_name=w1.image_folder_name and p1.experiment_date=w1.experiment_date and p1.edu_stainset_number = 0 and pw.id=?; SELECT p1.IXM_w2, p1.images_folder_name, w2.w2_filepath, w2.site_number, w2.image_folder_path, w2.path_found, w2.experiment_date, w2.well_name FROM wavelength_2 w2, plate_wells pw, ucsc_csc_plates p1 WHERE w2.plate_name=pw.UCSC_CSC_plate and w2.cell_line=pw.Cell_lines and w2.timepoint=pw.TimePoint and w2.Magnification=pw.Magnification and w2.experiment_date=pw.experiment_date and pw.well_name=w2.well_name and p1.images_folder_name=w2.image_folder_path and p1.experiment_date=w2.experiment_date and p1.edu_stainset_number = 0 and pw.id=?; SELECT p1.IXM_w3, p1.images_folder_name, w3.w3_filepath, w3.site_number, w3.image_folder_name, w3.path_found, w3.experiment_date, w3.well_name FROM wavelength_3 w3, plate_wells pw, ucsc_csc_plates p1 WHERE w3.plate_name=pw.UCSC_CSC_plate and w3.cell_line=pw.Cell_lines and w3.timepoint=pw.TimePoint and w3.Magnification=pw.Magnification and w3.experiment_date=pw.experiment_date and pw.well_name=w3.well_name and p1.images_folder_name=w3.image_folder_name and p1.experiment_date=w3.experiment_date and p1.edu_stainset_number = 0 and pw.id=?;SELECT p1.IXM_w4, p1.images_folder_name, w4.w4_filepath, w4.site_number, w4.image_folder_name, w4.path_found, w4.experiment_date, w4.well_name FROM wavelength_4 w4, plate_wells pw, ucsc_csc_plates p1 WHERE w4.plate_name=pw.UCSC_CSC_plate and w4.cell_line=pw.Cell_lines and w4.timepoint=pw.TimePoint and w4.Magnification=pw.Magnification and w4.experiment_date=pw.experiment_date and pw.well_name=w4.well_name and p1.images_folder_name=w4.image_folder_name and p1.experiment_date=w4.experiment_date and p1.edu_stainset_number = 0 and pw.id=?";
   
 con.query(well_images_sql, [well_id, well_id, well_id, well_id, well_id, well_id, well_id, well_id], function(err, results, fields) {   
    if (err) {
            throw err;
    } else {
